...
HD_PWD='C:/Vivado/FinalProject/FinalProject.runs/mb_block_1_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_1_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_1_microblaze_0_1.tcl
