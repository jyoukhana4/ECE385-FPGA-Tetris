...
#
# Generated by Vivado on Thu May 08 12:55:20 -0500 2025
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_block_1.protoinst" -log simulate.log
}
