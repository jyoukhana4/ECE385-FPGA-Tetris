...
#
# Generated by export_simulation on Thu May 08 12:54:25 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './mb_block_1.sh' script.

./mb_block_1.sh -reset_run
...
./mb_block_1.sh -noclean_files

For more information on the script, please type './mb_block_1.sh -help'.
